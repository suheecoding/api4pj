...
* **마우스 우클릭 > Run As > JUnit Test** 를 클릭하여 실행합니다.
  ...
  ※ 콘솔 내용에서 입/출력 파라미터, 쿼리 를 확인 할 수 있스니다.
  ...
  **콘솔 내용**
    ...
    >>>>>>>>>>  문제 1번 API1 입력 파라미터 및 vo 변환 
     ...
     ==> reqBody={"year":2018,"name":"계정명","acctNo":"계좌번호","sumAmt":0}
     , api4RepVO=[year=2018, name=계정명, acctNo=계좌번호, sumAmt=0]
